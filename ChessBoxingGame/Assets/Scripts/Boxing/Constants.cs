...
public static class Constants
{
    public static class Enemy
    {
        ...
        public const float LIGHT_PUNCH_DAMAGE = 3.5f; //for single round, use 10.0f
        public const float HEAVY_PUNCH_FST_TELE_TIME = 0.55f;
        public const float HEAVY_PUNCH_SND_TELE_TIME = .35f;
        public const float HEAVY_PUNCH_DAMAGE = 7.0f; //for single round, use 15.0f
    ...
    public static class Player
    {
        ...
        public const float BLOCKING_REDUC = 0.65f;
